...
module ``08: The Good Kind of Discrimination`` = 
    ...
    let ``04 A discriminated union can refer to itself (i.e., it can be recursive).`` () =
        ...
        let a = (Node("hello", Node("echo", Empty, Empty), Node("hello", Empty, Node("hello", Empty, Node("echo", Empty, Empty)))))  // <-- you may want to spread this over multiple lines and/or let-bindings ...!
